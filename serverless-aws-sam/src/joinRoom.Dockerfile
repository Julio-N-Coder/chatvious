ARG function_directory="./roomRoutes/joinRoom"
...
WORKDIR /app/src/roomRoutes/joinRoom
...
WORKDIR ${LAMBDA_TASK_ROOT}/roomRoutes/joinRoom
COPY ${function_directory}/package*.json ./
RUN npm install

CMD ["roomRoutes/joinRoom/joinRoom.handler"]
