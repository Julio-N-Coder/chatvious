...
public class AWS4SignerForAuthorizationHeader extends AWS4SignerBase {
     ...
     *                        this
     *                        value should also be set as the header
    ...
    public String computeSignature(Map<String, String> headers,
        ...
        // canonicalize the headers; get the set of header names as well as the
        // names and values to go into the signature process
        String canonicalizedHeaderNames = getCanonicalizeHeaderNames(headers);
        String canonicalizedHeaders = getCanonicalizedHeaderString(headers);

        // canonicalize query string parameters if any have been supplied
